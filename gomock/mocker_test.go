...
func (c *Client) Get(ctx context.Context, req *Request, trace *Trace) (*Response, error) {
	if ret, ok := gomock.InvokeContext(ctx, clientType, "Get", ctx, req, trace); ok {
...
func MockGet(r *gomock.Manager) *gomock.Mocker32[context.Context, *Request, *Trace, *Response, error] {
	return gomock.NewMocker32[context.Context, *Request, *Trace, *Response, error](r, clientType, "Get")
}
...
func (c *Client) GetWithHeader(ctx context.Context, req *Request, trace *Trace) (*Response, map[string]string, error) {
	if ret, ok := gomock.InvokeContext(ctx, clientType, "GetWithHeader", ctx, req, trace); ok {
		return gomock.Unbox3[*Response, map[string]string, error](ret)
	}
	return &Response{Message: "9:yyy"}, nil, nil
}

// MockGetWithHeader registers a mock implementation for the GetWithHeader method.
func MockGetWithHeader(r *gomock.Manager) *gomock.Mocker33[context.Context, *Request, *Trace, *Response, map[string]string, error] {
	return gomock.NewMocker33[context.Context, *Request, *Trace, *Response, map[string]string, error](r, clientType, "GetWithHeader")
}
...
func TestMockWithContext(t *testing.T) {
	...
	r, ctx := gomock.Init(context.Background())
...
func NewMockClient(r *gomock.Manager) *MockClient {
	return &MockClient{r}
}
...
func (c *MockClient) Query(req *Request, trace *Trace) (*Response, error) {
	if ret, ok := gomock.Invoke(c.r, mockClientType, "Query", req, trace); ok {
		return gomock.Unbox2[*Response, error](ret)
	}
	panic("mock error")
}
...
func (c *MockClient) MockQuery() *gomock.Mocker22[*Request, *Trace, *Response, error] {
	return gomock.NewMocker22[*Request, *Trace, *Response, error](c.r, mockClientType, "Query")
}
...
func (c *MockClient) QueryWithHeader(req *Request, trace *Trace) (*Response, map[string]string, error) {
	if ret, ok := gomock.Invoke(c.r, mockClientType, "QueryWithHeader", req, trace); ok {
		return gomock.Unbox3[*Response, map[string]string, error](ret)
	}
	panic("mock error")
}
...
func (c *MockClient) MockQueryWithHeader() *gomock.Mocker23[*Request, *Trace, *Response, map[string]string, error] {
	return gomock.NewMocker23[*Request, *Trace, *Response, map[string]string, error](c.r, mockClientType, "QueryWithHeader")
}

func TestMockNoContext(t *testing.T) {

	r, _ := gomock.Init(context.Background())
